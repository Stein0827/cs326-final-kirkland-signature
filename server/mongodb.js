...
export class MapDatabase {
  ...
  async createEvent(event) {
    ...
    const res = await this.events.insertOne({'_id': ObjectId(event.id), 'host_id': event.host_id,  'host_name' : user.user_name, 'event_name': event.event_name, event_desc : 'event.event_ desc',
